...
# ==== PAGE 2: Model Performance Dashboard ====
    ...
    metrics_data = {
        ...
        "Precision (0)": [1.00, 0.98, 1.00, 0.93, 1.00, 1.00],
        "Precision (1)": [1.00, 0.96, 1.00, 0.94, 0.99, 1.00],
        "Recall (0)":    [1.00, 0.97, 1.00, 0.96, 0.99, 1.00],
        "Recall (1)":    [1.00, 0.97, 1.00, 0.90, 1.00, 1.00],
        "F1-Score (0)":  [1.00, 0.97, 1.00, 0.95, 0.99, 1.00],
        "F1-Score (1)":  [1.00, 0.96, 1.00, 0.92, 0.99, 1.00],
